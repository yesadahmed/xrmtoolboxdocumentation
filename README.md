...
Once created you have to authenticate them in Flows (https://make.powerapps.com/) website for working.<br/>Please note this tool works only with only oauth and certificates types connection.
